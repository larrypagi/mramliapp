...
# The urls
my_desc$set("URL", "https://github.com/ThinkR-open/mramliapp")
my_desc$set("BugReports", "https://github.com/ThinkR-open/mramliapp/issues")
# Save everyting
...
# Vignette
usethis::use_vignette("mramliapp")
